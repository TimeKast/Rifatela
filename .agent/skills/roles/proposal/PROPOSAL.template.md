...
- {{Problema principal en 2-4 bullets}}

### Resultado Esperado

- {{Resultados esperados en 2-4 bullets}}

### Por qué Esta Solución

- {{Valor para el negocio en 2-4 bullets}}
...
| --------- | ------------ | ------------------------------- |
| {{Rol 1}} | {{Quién es}} | {{Qué puede hacer - 3-5 items}} |
| {{Rol 2}} | {{Quién es}} | {{Qué puede hacer - 3-5 items}} |
...
1. **Revisión de esta propuesta** con el equipo del cliente
