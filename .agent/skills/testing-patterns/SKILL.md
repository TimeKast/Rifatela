...
> Principles for reliable unit and integration test suites.
> For E2E / Playwright / browser testing → see `webapp-testing` skill.
...
_Cross-reference: `webapp-testing` for E2E, Playwright, stability rules, and RBAC verification patterns._
